...
public class WavFile {
	...
	private long readSample() throws IOException, WavFileException {
		long val = 0;
		for (int b = 0; b < bytesPerSample; b++) {
			// System.out.println("BufferPointer: "+ bufferPointer + "bytesRead: "+
			// bytesRead);
	...
	public static void write_wav(String out_file, int numChannels, long numFrames, int validBits, long sampleRate,
			short sound[]) throws IOException, WavFileException {
	...
	public static WavFile read_wav(String in_file) throws IOException, WavFileException {
		...
		if (validbits != 16)
			throw new WavFileException("Bitanzahl von (" + validbits + ") wird nicht unterst�tzt");
